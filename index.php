    ...
    <div class="container">
        <div class="fio">
            ...
            <div class="fio-text">
                ...
                <span class="fio-text-after">3102</span>
            </div>
            <div class="fio-text">
...
<div class="main">
        ...
        <div class="container">
            <div class="graph-panel">
                <div class="panel-element">
                    <div id="image">
                        <img src="images/area.png" id="area-image" alt="">
                    </div>
                </div>
                <div class="panel-element">
                    <form id="shot" action="src/main.php" method="post">
                        <div class="panel-element-inner">
                            <h4 id="r-label">R: <span id="r_visible">1</span></h4>
                            <input type="hidden" name="r" id="r_value" value="1">
                            <button type="button" onclick="setValueR(this.value)" id="r_1" value="1">
                                1
                            </button>
                            <button type="button" onclick="setValueR(this.value)" id="r_1.5" value="1.5">
                                1.5
                            </button>
                            <button type="button" onclick="setValueR(this.value)" id="r_2" value="2">
                                2
                            </button>
                            <button type="button" onclick="setValueR(this.value)" id="r_2.5" value="2.5">
                                2.5
                            </button>
                            <button type="button" onclick="setValueR(this.value)" id="r_3" value="3">
                                3
                            </button>
                        </div>
                        <div class="panel-element-inner">
    ...
    <div id="history">
        <div class="container">
            ...
            <div class="panel-element">
                <form action="src/clearHistory.php">
...
<script src="src/radiusHandler.js"></script>
</html>